...
export class DataService {
  ...
  public getContinuousData(): any[] {
    return [
      ...
      {
        isAverageRow: true,
        effectSize: [0.93, 0.91, 0.94, true], // true indicates this is an average of other values
      }
    ];
  }
  ...
  public getDichotomousData(): any[] {
    return [
      ...
      {
        publicationYear: 2005, firstAuthor: 'Luukinen', studyName: 'unknown', country: 'FI', context: ['H'],
        period: [1991, 2000],
        studyType: ['PC'],
        sampling: ['A'],
        populationRecruited: ['C'],
        sampleAgeRecruited: [70, 100],
        contributingNumber: 152,
        baselineFemalePercentage: 59,
        sampleAgeMean: '75 approx',
        baselineEducation: '13% less than grade school',
        usedDiagnosticCriteria: true, screenedBeforeClinicalEvaluation: false,
        numFollowUps: 1,
      ...
      {
        publicationYear: 2009, firstAuthor: 'Karp', studyName: 'Kungsholmen', country: 'SE', context: ['H'],
        period: [1987, 1995],
        studyType: ['PC'],
        sampling: ['A'],
        populationRecruited: ['C'],
        sampleAgeRecruited: [75, 100],
        contributingNumber: 931,
        baselineFemalePercentage: 77,
        sampleAgeMean: 'unclear',
        baselineEducation: '47.8% elementary',
        usedDiagnosticCriteria: true, screenedBeforeClinicalEvaluation: false,
        numFollowUps: 2,
        followUpYears: [6, null],
        riskOfBias: LowMedHigh.Low,
        numberIncidentCases: 265,
        measureOfEffect: ['RR'],
        adjustedFor: 'age, sex, occupational complexity',
        cutoff: '8 years',
        effectSize: [1.67, 1.27, 2.22],
        weight: 10.88
      },
      {
      ...
      {
        isAverageRow: true,
        effectSize: [1.45, 1.29, 1.63, true], // true indicates this is an average of other values
      }
    ];
  }
    ...
    return [
      {
        ...
        followUpYears: [8, null],
        riskOfBias: LowMedHigh.Medium,
        numberIncidentCases: 52,
        measureOfEffect: ['HR'],
        adjustedFor: 'age',
        effectSize: [1.07, 0.92, 1.25],
  ...
  // ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  public getCategoricalDataMCI(): any[] {
    return [
      {
        // first section - any MCI
        category: 'Any MCI',
        publicationYear: 2004, firstAuthor: 'Tervo', studyName: 'unknown', country: 'FI', context: ['H'],
        period: [1997, 2002],
        studyType: ['PC'],
        sampling: ['R'],
        populationRecruited: ['C'],
        sampleAgeRecruited: [60, 76],
        contributingNumber: 549,
        baselineFemalePercentage: 61.6,
        sampleAgeMean: '67.8',
        baselineEducation: '9.3 (approx)',
        usedDiagnosticCriteria: false, screenedBeforeClinicalEvaluation: false,
        numFollowUps: 1,
      ...
      },
      {
        ...
        populationRecruited: ['C'],
        sampleAgeRecruited: [65, 100],
        contributingNumber: 685,
        baselineFemalePercentage: 53.7,
        sampleAgeMean: '73.9',
        baselineEducation: '31.9% <=3 years',
        usedDiagnosticCriteria: true, screenedBeforeClinicalEvaluation: true,
        numFollowUps: 1,
        followUpYears: [5, 'mean 3.8 (0.8)'],
        riskOfBias: LowMedHigh.Medium,
        numberIncidentCases: 155,
        measureOfEffect: ['IRR*'],
      ...
      },
      {
        ...
        populationRecruited: ['Af-Am'],
        sampleAgeRecruited: [65, 100],
        contributingNumber: 1727,
        baselineFemalePercentage: 66.7,
        sampleAgeMean: '73.5 (6.7)',
        baselineEducation: '9.8 (3.0)',
        usedDiagnosticCriteria: false,  screenedBeforeClinicalEvaluation: true,
        numFollowUps: 2,
        followUpYears: [5, null],
        riskOfBias: LowMedHigh.Medium,
        numberIncidentCases: 88,
        measureOfEffect: ['OR'],
