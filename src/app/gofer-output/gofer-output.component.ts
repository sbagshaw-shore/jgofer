...
export class GoferOutputComponent implements OnInit {
  ...
  private getColumnDefs() {
    return [
      ...
      { headerName: 'Period', field: 'period', cellRenderer: this.grid.getRangedLineCellRenderer(1982, 2013, true, '?'), width: 400 },
      ...
      { headerName: 'Sample age recruited', field: 'sampleAgeRecruited', cellRenderer: this.grid.getRangedLineCellRenderer(60, 100, true, '?'), width: 400 },
      ...
      { headerName: 'Follow-up years', field: 'followUpYears', cellRenderer: this.grid.getRangedLineCellRenderer(0, 20, false, '?', true), width: 400 },
  ...
  private setupRowData() {
    ...
    const data: any[] = [
      ...
      },
      {
        ...
        followUpYears: [4, null, 'presume 4'],
        riskOfBias: LowMedHigh.Medium,
