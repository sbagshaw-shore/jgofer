...
export class GoferOutputComponent implements OnInit {
  ...
  private getColumnDefs() {
    return [
      ...
      { headerName: 'Period', field: 'period', cellRenderer: this.grid.getRangedLineCellRenderer(1982, 2013, false, 'Unclear'), width: 250 },
      ...
      { headerName: 'Sample age recruited', field: 'sampleAgeRecruited', cellRenderer: this.grid.getRangedLineCellRenderer(60, 100, false, 'Unclear'), width: 250 },
      ...
      { headerName: 'Sample age mean (SD)', field: 'sampleAgeMean', isDataMultiline: true, width: 230 },
